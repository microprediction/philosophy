...
rebukes, what survives, references), add a card to the list in `docs/index.html`, and add an entry to `REBUKES` in
`docs/nav.js` so it shows up in the nav dropdown on every page.
See the [house rules](https://microprediction.github.io/philosophy/house-rules.html).
